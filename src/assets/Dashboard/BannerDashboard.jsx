...
export default function BannerDashboard() {
    ...
    const delBanner = async () => {
        ...
        try {
            const response = await axios.delete(
                `https://travel-journal-api-bootcamp.do.dibimbing.id/api/v1/delete-banner/${selectedUserId}`,
                {
                    headers: {
                        apiKey: "24405e01-fbc1-45a5-9f5a-be13afcd757c",
    ...
    const updateBanner = () => {
        ...
        axios
            .post(
                `https://travel-journal-api-bootcamp.do.dibimbing.id/api/v1/update-banner/${selectedUserId}`,
                payload,
                {
                    headers: {
                        apiKey: "24405e01-fbc1-45a5-9f5a-be13afcd757c",
                            ...
                            {detail.filter((item) => {
                                ...
                                <div className="h-full flex flex-col gap-2 items-center justify-center">
                                    ...
                                    <div className="flex gap-2">
                                        <button onClick={() => setShowModal(true)} className="bg-green-600 text-white px-4 py-2 rounded-3xl">Update</button>
                                        <button onClick={() => setShowDeleteModal(true)} className="bg-[#0A82FD] text-white px-4 py-2 rounded-3xl">Delete</button>
                                    </div>
                                </div>
                            </div>))}
                        </div>
